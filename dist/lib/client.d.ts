import { PendingReqs, IData, IStream, ServiceClientConstructor, PugdagdPackage, SubscriberItemMap, RPC as Rpc } from '../types/custom-types';
export declare class Client {
    ...
    verbose: boolean;
    log: Function;
    proto: PugdagdPackage | undefined;
